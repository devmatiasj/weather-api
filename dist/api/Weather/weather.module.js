...
exports.WeatherModule = WeatherModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [weather_service_1.WeatherService, location_service_1.LocationService, http_service_1.HttpService, weather_mapper_1.WeatherMapper, location_mapper_1.LocationMapper],
    })
], WeatherModule);

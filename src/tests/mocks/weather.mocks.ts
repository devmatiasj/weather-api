import { CurrentWeather, ForecastWeather, ForecastItem } from '../../models/weather.model';
...
const mockForecastItem1: ForecastItem = {
  dt: 1709910000,
...
const mockForecastItem2: ForecastItem = {
  dt: 1709920800,
...
const mockForecastWeather: ForecastWeather = {
  cod: '200',
  message: 0,
  cnt: 40,
...
export { mockCurrentWeather, mockForecastWeather };